    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="t_ua.php">
            ...
            ?>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div>
                                <?php echo "<a href='t_ua_asp.php?id=$id&&email=$email&&section=$section&&cname=$cname&&name=$name'><button type='button' class='btn btn-success'>Accept</button></a>" ?>
                                </div>
