...
if ($result) {
    $sname = $data['name'];
    $cgpa = $data['cgpa'];
    $_SESSION['photo'] = $data['image']; //.show photo multiple page;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($cgpa > 3.69) {
        ...
        {
        window.open('s_home.php','s_home.php');
            ...
            echo "<script type='text/javascript'>if (window.confirm('Your Application is Granted'))
    {
    window.open('s_home.php','s_home.php');
        ...
        <form action="" method="POST">
            ...
            <select name="ua" id="ua">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "  <option value='$id'>Course:$course_name  Course id: '$id' Teacher Name: $tname Section: $section  Class Start: $start Class End:$end</option>"; 
